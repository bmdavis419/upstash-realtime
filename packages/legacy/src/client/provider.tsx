...
import { useRealtime, type UseRealtimeOpts } from "./use-realtime";
  ...
  const connect = (opts?: ConnectOpts) => {
    ...
    try {
      ...
      eventSource.onerror = () => {
        ...
        if (readyState === EventSource.prototype.CONNECTING) return;

        if (readyState === EventSource.prototype.CLOSED) {
